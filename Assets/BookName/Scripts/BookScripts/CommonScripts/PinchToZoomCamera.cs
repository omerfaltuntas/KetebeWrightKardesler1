...
{
    public static PinchToZoomCamera instance;
    ...
    Vector3 _touchStart;
    private ImageSwiper ImageSwiper;

    private void Start()
    {
        instance = this;
        ImageSwiper = GetComponent<ImageSwiper>();
    ...
    public void ZoomActiverDeactiver()
    {
        ...
        ImageSwiper.enabled = !ImageSwiper.enabled;

        GameObject myObject = ImageSwiper.pages[ImageSwiper.choosenPage];
